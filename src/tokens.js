import {Aad_provisioner,Abort_detached_query,Abort_statement,Access,Account,Admin,Admin_name,Admin_password,After,Allow_duplicate,Allow_overlapping_execution,Allowed_IP_List,And,Api,Api_allowed_prefixes,Api_aws_role_arn,
  ...
  X4large,Xlarge,Xml,Xsmall,Xxlarge,Xxxlarge,Yearly,Zstd,} from './parser.terms.js';
